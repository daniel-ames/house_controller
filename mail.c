...
/*
The following are to be defined in a non-versioned include file (for obvious reasons).
...
authinteract (auth_client_request_t request, char **result, int fields, void *arg)
{
  ...
  char mailbox_user[] = "ameshousecontroller";
  char app_password[] = "rfbx thwj yjzb iurp";
